...
def calculate_segmentation_metrics(
    ...
    Args:
        pre_eval_results (list): Lists of (area_intersect, area_union, area_pred_label, and area_label). These are
            intermediate results to compute the final metrics such as iou, fscore, etc.
...
def total_area_to_metrics(
    ...
    Args:
        ...
        metrics (list[str] | str): Metrics to be evaluated, can be 'mIoU', 'mDice', or 'mFscore'.
        beta (int): Parameter for computing F-score. Defaults to 1 (for computing F1-score).
