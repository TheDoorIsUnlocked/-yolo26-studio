...
def create_sop_training_pdf():
    ...
    story.append(Paragraph("基于YOLO26框架", ParagraphStyle('Subtitle', 
        parent=styles['Normal'], fontSize=12, alignment=TA_CENTER, 
        textColor=colors.HexColor('#7f8c8d'), fontName=chinese_font)))
...
"""
    ...
    story.append(Paragraph("文档版本: 1.0", ParagraphStyle('Footer', 
        parent=styles['Normal'], fontSize=8, alignment=TA_CENTER, 
        textColor=colors.HexColor('#95a5a6'), fontName=chinese_font)))
    story.append(Paragraph("生成日期: 2026-02-11", ParagraphStyle('Footer', 
        parent=styles['Normal'], fontSize=8, alignment=TA_CENTER, 
        textColor=colors.HexColor('#95a5a6'), fontName=chinese_font)))
