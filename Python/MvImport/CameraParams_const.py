...
MV_MAX_INTERFACE_NUM = (
    64  # < \~chinese 最大支持的采集卡数量  @~english The maximum number of Frame Grabber interface supported
)
...
MV_MAX_GENTL_DEV_NUM = (
    256  ## @~chinese 最大支持的GenTL设备数量      @~english The maximum number of GenTL devices supported
)
