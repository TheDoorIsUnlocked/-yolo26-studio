...
def check_feature_node_access(cam_ins, node_name):
    ...
    if res != 0:
        return False
    return bool(access_mode == AM_WO or access_mode == AM_RO or access_mode == AM_RW)
