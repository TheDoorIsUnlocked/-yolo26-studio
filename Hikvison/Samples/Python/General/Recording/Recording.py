...
if __name__ == "__main__":
    try:
        ...
        if ret != 0:
            raise Exception(f"get AcquisitionFrameRateEnable fail! ret[0x{ret:x}]")
        ...
        if ret != 0:
            raise Exception(f"get width fail! nRet [0x{ret:x}]")
        ...
        if ret != 0:
            raise Exception(f"get height fail! nRet [0x{ret:x}]")
        ...
        if ret != 0:
            raise Exception(f"get PixelFormat fail! nRet [0x{ret:x}]")
        ...
        if ret != 0:
            raise Exception(f"get ResultingFrameRate value fail! nRet [0x{ret:x}]")
        ...
        if ret != 0:
            raise Exception(f"stop Record fail! ret[0x{ret:x}]")
