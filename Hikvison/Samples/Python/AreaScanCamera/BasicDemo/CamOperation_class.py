...
def Is_color_data(enGvspPixelType):
    return bool(
        ...
        or PixelType_Gvsp_BayerGR16 == enGvspPixelType
        or PixelType_Gvsp_BayerRG16 == enGvspPixelType
        or PixelType_Gvsp_BayerGB16 == enGvspPixelType
        or PixelType_Gvsp_BayerBG16 == enGvspPixelType
        ...
        if not self.b_open_device:
            ...
            if stDeviceList.nTLayerType == MV_GIGE_DEVICE or stDeviceList.nTLayerType == MV_GENTL_GIGE_DEVICE:
                ...
                if int(nPacketSize) > 0:
                    ...
                    print(f"warning: set packet size fail! ret[0x{nPacketSize:x}]")
